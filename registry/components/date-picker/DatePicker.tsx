...
const DatePicker = ({
    ...
    const getFirstDayOfMonth = (month: number, year: number) => {
        ...
        // Adjust for Monday start if needed, but we'll stick to Sunday start based on original design
        return day;
    };
    ...
    const renderCalendarIcon = (color: string) => (
    ...
    const renderChevron = (color: string) => (
